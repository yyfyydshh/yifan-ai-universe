...
const evidence = {
  ...
  final_status: "pass",
  verification_note: "v23 adopts the approved deep-space system and closes the release surface: responsive navigation, contact QR/email/phone, project mast facts, seven captioned videos, metadata/discovery, automated route and interaction regression, and exact desktop/ultrawide/mobile evidence. The homepage single-orbit portrait universe and all project facts remain unchanged.",
  media_assets: [
    {
      ...
      captions: "public/captions/global-opinion-agent-demo.zh-CN.vtt",
      status: "ready",
    },
    {
